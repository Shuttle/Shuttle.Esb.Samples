...
{
    public class OrderProcessArchivedHandler : IAsyncMessageHandler<OrderProcessArchived>
    {
        ...
        public async Task ProcessMessageAsync(IHandlerContext<OrderProcessArchived> context)
        {
