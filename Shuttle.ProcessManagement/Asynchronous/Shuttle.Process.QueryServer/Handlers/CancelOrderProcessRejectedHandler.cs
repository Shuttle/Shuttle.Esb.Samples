...
{
    public class CancelOrderProcessRejectedHandler : IAsyncMessageHandler<CancelOrderProcessRejected>
    {
        ...
        public async Task ProcessMessageAsync(IHandlerContext<CancelOrderProcessRejected> context)
        {
