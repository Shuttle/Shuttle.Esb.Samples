...
app.MapGet("/orders", async (IOrderProcessService orderProcessService) =>
{
    return await Guard.AgainstNull(orderProcessService, nameof(orderProcessService)).ActiveOrdersAsync();
});

app.MapDelete("/orders/{id:guid}", async (IOrderProcessService orderProcessService, Guid id) =>
{
    await Guard.AgainstNull(orderProcessService, nameof(orderProcessService)).CancelOrderAsync(id);
});

app.MapDelete("/orders/{id:guid}/archive", async (IOrderProcessService orderProcessService, Guid id) =>
{
    await Guard.AgainstNull(orderProcessService, nameof(orderProcessService)).ArchiveOrderAsync(id);
});

app.MapPost("/orders", async (IServiceBus serviceBus, IProductQuery productQuery, RegisterOrderModel model) => {
    ...
    await serviceBus.SendAsync(message, builder =>
    {
