...
{
    public class ArchiveOrderProcessRejectedHandler : IMessageHandler<ArchiveOrderProcessRejected>
    {
        ...
        public void ProcessMessage(IHandlerContext<ArchiveOrderProcessRejected> context)
        {
