  ...
  <div id="app">
    <nav class="navbar navbar-dark bg-dark">
        ...
        <ul class="navbar-nav flex-row ml-md-auto d-none d-md-flex">
            <li class="nav-item">
                <a class="nav-link p-2" href="https://vuejs.org/" target="_blank" rel="noopener" aria-label="Canjs">
                    <img src="./assets/logo.png" class="d-inline-block align-middle" alt="" style="width: 20px; height: 20px;">
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link p-2" href="https://getbootstrap.com/" target="_blank" rel="noopener" aria-label="Bootstrap">
                    <img src="./assets/bootstrap-solid.svg" class="d-inline-block align-middle" alt="" style="width: 20px; height 20px;">
                </a>
            </li>
            <li class="nav-item">
...
export default {
  name: 'app',
  components: {
    'shuttle-books': ShuttleBooks,
    'shuttle-orders': ShuttleOrders
  }
}
</script>
