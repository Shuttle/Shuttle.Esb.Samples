        ...
        <table class="table table-sm">
            ...
            <tbody>
                <tr v-for="order in orders" v-bind:key="order.orderNumber" class="row">
                    <td class="col-1">
                        <button v-if="order.canCancel" v-on:click="cancelOrder(order)"
                            class="btn btn-default btn-danger btn-sm">Cancel</button>
                        <button v-if="order.canArchive" v-on:click="archiveOrder(order)"
                            class="btn btn-default btn-danger btn-sm">Archive</button>
                    </td>
