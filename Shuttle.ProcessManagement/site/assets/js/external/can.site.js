 ...
 * Fri, 23 Oct 2015 18:06:55 GMT
 * Licensed MIT

 * Includes: can/component/component,can/construct/construct,can/map/map,can/list/list,can/compute/compute,can/model/model,can/view/view,can/control/control,can/route/route,can/control/route/route,can/view/mustache/mustache,can/view/stache/stache,can/construct/super/super,can/map/validations/validations,can/map/define/define,can/util/fixture/fixture
 * Download from: http://bitbuilder.herokuapp.com/can.custom.js?configuration=jquery&plugins=can/component/component&plugins=can/construct/construct&plugins=can/map/map&plugins=can/list/list&plugins=can/compute/compute&plugins=can/model/model&plugins=can/view/view&plugins=can/control/control&plugins=can/route/route&plugins=can/control/route/route&plugins=can/view/mustache/mustache&plugins=can/view/stache/stache&plugins=can/construct/super/super&plugins=can/map/validations/validations&plugins=can/map/define/define&plugins=can/util/fixture/fixture
 */
/*[global-shim-start]*/
