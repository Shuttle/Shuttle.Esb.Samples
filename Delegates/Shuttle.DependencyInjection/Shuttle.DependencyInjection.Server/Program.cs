            ...
            .ConfigureServices(services =>
            {
                ...
                services
                    ...
                    .AddServiceBus(builder =>
                    {
                        ...
                        builder.AddMessageHandler(async (IHandlerContext<RegisterMember> context, IEMailService emailService) =>
                        {
                            Console.WriteLine();
                            Console.WriteLine($"[MEMBER REGISTERED] : user name = '{context.Message.UserName}'");
                            Console.WriteLine();

                            await emailService.SendAsync(context.Message.UserName);
                        });
                    })
